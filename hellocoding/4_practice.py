...
#
#
# def count_element1(arr):
#     if arr == []:
#         return 0
#     else:
#         return 1 + count_element1(arr[1:])
#
#
# print('4-2(3)')
# t1 = time.time()
# print(count_element1([1, 2, 3, 4, 5, 100]))
# # time.sleep(1)
# t2 = time.time() - t1
# print(t2)
#
#
# def count_element2(arr):
#     if len(arr) == 1:
#         return 1
#     else:
#         return 1 + count_element2(arr[1:])
#
#
# t1 = time.time()
# print(count_element1([1, 2, 3, 4, 5, 100]))
...
t1 = time.time()
print(find_the_big([4, 100, 3, 2, 64]))
t2 = time.time() - t1
print(t2)
...
# 181125 추가(3)
# 결국 책에서한 것은 arr[0] 하나 잡아놓고 나머지 두개 두개 두개 씩 비교해서 가장 큰 값 하나 찾는 것.
# 선택 정렬처럼 답찾는 것과 똑같다..
